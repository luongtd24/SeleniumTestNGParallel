...
public class CaptureHelper extends ScreenRecorder {
    ...
    public static void startRecord(String recordName) {
        ...
        File file = new File(SystemHelpers.getCurrentDir() + PropertiHelper.getValue("VIDEO_RECORD_PATH"));
    ...
    public static void captureScreenshot(String screenshotName) {
        try {
            ...
            File theDir = new File(SystemHelpers.getCurrentDir() + PropertiHelper.getValue("SCREENSHOT_PATH"));
            if (!theDir.exists()) {
                theDir.mkdirs();
            }
            // Chổ này đặt tên thì truyền biến "screenName" gán cho tên File chụp màn hình
            FileHandler.copy(source, new File(SystemHelpers.getCurrentDir() + PropertiHelper.getValue("SCREENSHOT_PATH") + File.separator + screenshotName + "_" + dateFormat.format(new Date()) + ".png"));
    ...
    public static void TakeScreenshot(String screenshotName) {
        ...
        try {
            FileHandler.copy(source, new File(SystemHelpers.getCurrentDir() + PropertiHelper.getValue("SCREENSHOT_PATH") + screenshotName + ".png"));
            System.out.println("Take screenshot " + screenshotName + " successfully");
        } catch (IOException e) {
            System.out.println("ERROR. Cannot take screenshot " + screenshotName + ".");
            e.printStackTrace();
        }    // Capture screenshot
    }
}
